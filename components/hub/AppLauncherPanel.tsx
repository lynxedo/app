...
export default function AppLauncherPanel({
  ...
  return (
    <>
      ...
      <div className="t-sidebar-surface hidden md:flex fixed left-16 top-0 bottom-0 z-50 w-72 flex-col overflow-hidden shadow-2xl" style={{ background: 'linear-gradient(180deg,var(--t-well),var(--t-rail))', borderRight: '1px solid rgba(255,255,255,.08)' }}>
