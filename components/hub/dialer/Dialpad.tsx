...
export default function Dialpad({
  ...
  return (
    ...
    >
      <div className="mb-4 text-center min-h-[2.5rem]">
        <input
          type="tel"
          ...
          inputMode="tel"
          className="w-full bg-transparent text-center text-3xl font-light tracking-wider text-white placeholder-white/30 outline-none"
        />
      </div>
      ...
      <div className="grid grid-cols-3 gap-3 mb-5">
        {KEYS.map((k) => (
          ...
          >
            ...
            {k.letters && (
              <span className="text-[10px] tracking-widest text-white/40 mt-0.5">
                {k.letters}
              </span>
            )}
          </button>
      ...
      <div className="flex items-center justify-center gap-6">
        ...
        <button
          ...
          className="w-16 h-16 rounded-full bg-emerald-600 hover:bg-emerald-500 disabled:bg-white/5 disabled:text-white/30 active:scale-95 transition-all flex items-center justify-center shadow-lg"
          aria-label="Call"
        >
        ...
        <button
          ...
          onClick={backspace}
          disabled={!value}
          className="w-12 h-12 rounded-full hover:bg-white/10 disabled:opacity-30 flex items-center justify-center text-white/60"
          aria-label="Delete"
        >
