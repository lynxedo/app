...
<p className="mt-3"><strong className="text-white">If a line shows $0, its programs are missing a visits-per-year.</strong> A book&apos;s annual value is visits-per-year × price, so a program without that number adds nothing. The card tells you how many jobs it couldn&apos;t price and which lines they&apos;re on, rather than quietly reporting zero. Ask an admin to set it in <strong className="text-white">Admin &rarr; Reports &rarr; Recurring programs</strong>.</p>
      ...
      <Section title="Narrowing A Card To One Person">
        ...
        <p className="mt-3"><strong className="text-white">Cards that have it:</strong> Visit Revenue by Technician · Revenue per Hour — One Person · Hours Clocked · Revenue per Hour by Technician · Hours by Person · Crew Detail · Sales by Person · Quotes By Salesperson · Quotes Waiting For An Answer · both Tracked Items cards.</p>

        <p className="mt-3"><strong className="text-white">Cards that don&apos;t, and why.</strong> <em>Revenue per Labor Hour</em>, <em>Labor Cost %</em> and <em>Revenue per Visit</em> stay company-wide on purpose. When two techs work the same visit, that visit&apos;s revenue is credited to both — so adding up one person&apos;s share of company revenue overstates it, and a per-person version of those ratios would read high and wouldn&apos;t reconcile with anything. Hours don&apos;t have that problem, which is why <em>Hours Clocked</em> can be filtered and the ratios can&apos;t. The <em>What the Numbers Say</em> cards are also left alone — they&apos;re written about the whole team, so narrowing them would just make the sentences wrong.</p>
