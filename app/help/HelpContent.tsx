  ...
  return (
    <>
      ...
      <Section title="Email Marketing (new)">
        ...
        <p className="mt-2"><strong className="text-white">Campaigns (one-off blasts).</strong> A campaign pairs a <strong className="text-white">template</strong> with a <strong className="text-white">segment</strong> and sends it out. In the Campaigns tab, hit <em>+ New campaign</em>, pick the template, then pick who it goes to — either <strong className="text-white">a segment</strong> (a saved segment, or <em>Everyone</em>) or <strong className="text-white">Pick contacts</strong> to hand-select individual people (search by name or email). Either way you&apos;ll see a live <strong className="text-white">≈ N recipients</strong> count. Choose <strong className="text-white">Send now</strong> or <strong className="text-white">Schedule</strong> a date/time. Sends go out steadily in the background (throttled, never all at once), and the campaign row shows a live progress bar with <em>sent / failed / skipped</em> counts. Every email automatically carries a one-click unsubscribe and your mailing address (CAN-SPAM), and anyone unsubscribed or suppressed is skipped — even if they opt out <em>after</em> the campaign is queued. Hit <strong className="text-white">Stop</strong> to halt a campaign that&apos;s still sending (remaining recipients are skipped), or <strong className="text-white">Remove</strong> to clear a finished one from the list.</p>
