  ...
  return (
    <>
      ...
      <Section title="Reports vs Scoreboards">
        ...
        <p className="mt-2 text-gray-400"><strong className="text-white">Goals &amp; Targets</strong> is where a number you are aiming at gets checked against what actually happened. An admin sets targets at the bottom of <strong className="text-white">Admin → Reports</strong> &mdash; pick a measure (invoiced, cash collected, new customers, leads, value sold, close rate, revenue per labour hour), pick monthly, quarterly or yearly, pick any date inside that period, and type the number. The report then shows target, actual, attainment and status for every target that overlaps the range you have selected.</p>
        ...
        <p className="mt-2 text-gray-400"><strong className="text-white">Four measures can be set for one person:</strong> leads, value sold, close rate, and revenue per labour hour. The other three &mdash; invoiced, cash collected and new customers &mdash; are company-only, and the screen tells you why when you pick one: invoices record a salesperson on only about a third of rows, a payment records nobody at all, and new customers are not broken down per person anywhere, so working one out separately would disagree with the Clients report. Rather than offer a target that could never be scored, those simply cannot be set for a person.</p>
