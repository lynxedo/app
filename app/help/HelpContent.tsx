  ...
  return (
    <>
      ...
      <Section title="Boards &amp; Tasks">
        ...
        <p className="mt-3"><strong className="text-white">My Tasks</strong> — the <strong className="text-white">My Tasks</strong> link in the sidebar gathers <em>every open task assigned to you</em> from all your boards into one list, grouped Overdue / Today / Upcoming. Check tasks off right there. Use the <strong className="text-white">Boards</strong> button to choose which boards feed your list — that&apos;s personal to you and doesn&apos;t affect anyone else&apos;s.</p>
