...
<p className="mt-3"><strong className="text-white">If a line shows $0, its programs are missing a visits-per-year.</strong> A book&apos;s annual value is visits-per-year × price, so a program without that number adds nothing. The card tells you how many jobs it couldn&apos;t price and which lines they&apos;re on, rather than quietly reporting zero. Ask an admin to set it in <strong className="text-white">Admin &rarr; Reports &rarr; Recurring programs</strong>.</p>
      ...
      <Section title="Commission">
        ...
        <p className="mt-3"><strong className="text-white">Freezing a month once it is paid.</strong> A rule can carry <strong className="text-white">in force from</strong> and <strong className="text-white">in force until</strong> dates. Leave both blank and it applies to every period — which is how rules always worked, and it means changing a rate also changes what <em>earlier</em> months report. Once you have paid a month, set <em>in force until</em> on the old rule and add a new one starting the next day; both then stay reproducible. One real case: April was paid at a flat $35 per upsell and could not be reproduced afterwards, because the rule had since become 5%.</p>
        ...
        <p className="mt-2 text-gray-400"><strong className="text-white">Bonus weeks.</strong> Rules paid on <em>revenue produced</em> or <em>revenue per labour hour</em> can be measured over your bonus weeks instead of the calendar month. <strong className="text-white">W1 starts on the last Monday on or before the 1st</strong>, and W1&ndash;W4 are the four weeks — for August 2026 that is Jul 27&ndash;Aug 2, Aug 3&ndash;9, Aug 10&ndash;16 and Aug 17&ndash;23. Two settings use them: <em>bonus weeks added together</em> (one calculation over the four weeks) and <em>each bonus week on its own</em> (the four judged separately and added, so a week that falls short pays nothing for that week and a week nobody worked pays nothing rather than being averaged away). The Commission Detail card lists what each week was worth and what each paid.</p>
        <p className="mt-2 text-amber-300/90">⚠ <strong className="text-white">Four bonus weeks cover 28 days, so a long month leaves a gap.</strong> August 2026&apos;s W4 ends on the 23rd and September&apos;s W1 does not start until the 31st, which leaves Aug 24&ndash;30 in <em>no</em> bonus week at all — work done then is in nobody&apos;s bonus period. That happens two or three months a year. The card names those exact days when it happens, so it is visible rather than quietly unpaid; tell us if you want that week paid somewhere instead.</p>
