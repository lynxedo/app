  ...
  return (
    <>
      ...
      <Section title="Reports vs Scoreboards">
        ...
        <p className="mt-2 text-gray-400"><strong className="text-white">Goals &amp; Targets</strong> is where a number you are aiming at gets checked against what actually happened. An admin sets targets in <strong className="text-white">Admin → Goals</strong> &mdash; pick a measure (invoiced, cash collected, new customers, leads, value sold, close rate, revenue per labour hour), pick monthly, quarterly or yearly, pick any date inside that period, and type the number. The report then shows target, actual, attainment and status for every target that overlaps the range you have selected.</p>
