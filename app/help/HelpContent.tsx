  ...
  return (
    <>
      ...
      <Section title="Account — Notifications: This device">
        ...
        <p className="mt-3">In a web browser or PWA you&apos;ll also see a <strong className="text-white">&ldquo;Play a sound for new messages&rdquo;</strong> toggle. When it&apos;s on, Hub plays a short chime on this device whenever a new message arrives <em>while the Hub tab is open but you&apos;re on another tab or in another app</em> — so you get an audible heads-up without watching the screen. It respects your mute / mentions-only / Do Not Disturb settings, stays quiet while you&apos;re actively looking at Hub, and is remembered per device (turn it on at your desk, leave it off on a shared machine). It only works while a Hub tab is open in that browser; once the browser is fully closed, the regular push notification takes over. Flipping it on plays a quick preview so you know what it sounds like.</p>
