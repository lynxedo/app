    ...
    <>
      ...
      <Section title="Reports vs Scoreboards">
        ...
        <ul className="list-disc list-inside text-gray-400 space-y-1 ml-2 mt-2">
          ...
          <li><strong className="text-white">Service Line Profitability</strong> — which parts of the business (irrigation, weed &amp; feed, pet waste, mowing) actually pay for the crew time they take.</li>
