    ...
    <>
      ...
      <Section title="Tank loadout (Advanced)">
        ...
        <ul className="list-disc list-inside text-gray-400 space-y-1 ml-2">
          ...
          <li><strong className="text-white">Which tank each line item&apos;s product goes in</strong> — each product row (under its line item) has its own tank dropdown, so the <em>same</em> product can go in Tank 1 for one line item and Tank 2 for another (e.g. &ldquo;today Root Rot&apos;s anchor goes in Tank 1, Lawn Health Complete&apos;s in Tank 2&rdquo;). Your choices are remembered for that route and day; they don&apos;t change anyone else&apos;s run.</li>
        </ul>
