  ...
  return (
    <>
      ...
      <Section title="The conversation list">
        ...
        <p><strong className="text-white">Archive all mine</strong> — on the <strong className="text-white">Mine</strong> tab there&apos;s a small <em>Archive all mine</em> link that archives every conversation you currently own in one tap. It asks you to confirm with a count first, and it only touches threads you <em>own</em> — conversations you&apos;ve merely joined as a member are left alone.</p>
