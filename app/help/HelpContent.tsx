  ...
  return (
    <>
      ...
      <Section title="Reports vs Scoreboards">
        ...
        <p className="mt-2 text-gray-400"><strong className="text-white">Nine measures can be set for one person:</strong> leads, value sold (all, new business, or upsells), deals won, average deal size, close rate, work produced, and revenue per labour hour. Everything else is company-only, and the screen tells you why when you pick one: invoices record a salesperson on only about a third of rows, a payment records nobody at all, new customers are not broken down per person anywhere, quotes record a name that the People report does not carry, and the phone figures are not held per person. Rather than offer a target that could never be scored, those simply cannot be set for a person.</p>
