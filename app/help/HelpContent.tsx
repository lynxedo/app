    ...
    <>
      ...
      <Section title="Reports vs Scoreboards">
        ...
        <ul className="list-disc list-inside text-gray-400 space-y-1 ml-2 mt-2">
          ...
          <li><strong className="text-white">Sales &amp; Pipeline</strong> — leads in, close rate, value sold, who is closing, which sources convert, why leads are lost, and what is still open. Built from the Lead Tracker.</li>
