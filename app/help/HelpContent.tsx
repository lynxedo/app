...
function MarketingTab() {
  return (
    <>
      ...
      <Section title="Email Marketing (new — foundation)">
        <p>Open <strong className="text-white">Marketing → Email</strong> to reach the new in-Hub email module. The foundation is live now; campaigns, contact import, and automated drip sequences arrive in later sessions.</p>
        ...
        <p className="mt-2"><strong className="text-white">Contacts &amp; import.</strong> Your master audience lives in the Hub. <strong className="text-white">Jobber clients sync in automatically</strong> (with their tags) via <em>Admin → Email Marketing → Sync from Jobber</em>. For everyone else — your Mailchimp-only contacts and your opt-outs — export your Mailchimp audience (Audience → All contacts → Export) and upload each file (subscribed / unsubscribed / cleaned) with <em>Import Mailchimp CSV</em>. The importer dedupes on email (so a Jobber client who's also in Mailchimp is merged, not duplicated), carries the Mailchimp <em>TAGS</em> across, and routes unsubscribed + cleaned addresses straight to the suppression list. Every import shows a created / merged / suppressed / skipped summary.</p>
