  ...
  return (
    <>
      ...
      <Section title="Drip (speed-to-lead follow-up)">
        ...
        <p className="mt-2"><strong className="text-white">Settings.</strong> The <em>Settings</em> button sets the defaults for all campaigns: <strong className="text-white">who texts are sent as</strong> (drip texts land in that team member&apos;s Txt inbox, so replies surface there — this must be set before a campaign can send), <strong className="text-white">quiet hours</strong> (default 8am–8pm, messages due outside the window wait until it opens), a <strong className="text-white">max messages per lead per day</strong> cap, and your <strong className="text-white">business name</strong>.</p>
