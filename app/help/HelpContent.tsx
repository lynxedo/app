  ...
  return (
    <>
      ...
      <Section title="Email Marketing (new)">
        <p>Open <strong className="text-white">Marketing → Email</strong> to reach the new in-Hub email module. Templates and segments are live now; one-off campaigns and automated drip sequences arrive in later sessions. The page has three tabs: <strong className="text-white">Overview</strong>, <strong className="text-white">Templates</strong>, and <strong className="text-white">Segments</strong>.</p>
        <p className="mt-2"><strong className="text-white">Templates.</strong> Reusable email content. Give a template a name, a subject line, and a body written in simple <em>Markdown</em> — <code className="text-gray-300">**bold**</code>, <code className="text-gray-300">*italic*</code>, <code className="text-gray-300"># headings</code>, <code className="text-gray-300">- lists</code>, and <code className="text-gray-300">[links](url)</code>. Drop in <strong className="text-white">merge fields</strong> like <code className="text-gray-300">{'{{first_name}}'}</code> (also <code className="text-gray-300">{'{{last_name}}'}</code> and <code className="text-gray-300">{'{{email}}'}</code>) using the Insert buttons; they fill in per-recipient at send time. Hit <em>Preview</em> to see the rendered email with sample values, or <em>Send test to myself</em> to get the draft in your own inbox (subject is prefixed with <em>[TEST]</em> and merge fields use your own name).</p>
