  ...
  return (
    <>
      ...
      <Section title="Groups &amp; broadcasts">
        <p><strong className="text-white">Group</strong> texts (<strong className="text-white">+ Group</strong> in the composer) include several customers on one thread — available to everyone with Txt. <strong className="text-white">Broadcasts</strong> <span className="text-gray-500">(managers only)</span> send one message to many customers as separate individual texts (not a group thread) — good for seasonal announcements. Broadcasts automatically skip anyone who&apos;s opted out, and go out throttled over time so the carrier doesn&apos;t flag them. Track them at <strong className="text-white">Txt → Broadcasts</strong>.</p>
      </Section>
