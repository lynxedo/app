  ...
  return (
    <>
      ...
      <Section title="Irrigation system">
        ...
        <Step n={4}>Tap <strong className="text-white">Save inspection</strong> when you&apos;re done — that stamps a permanent dated record. Left as a draft, it shows a &ldquo;draft in progress&rdquo; note and a <strong className="text-white">Resume draft</strong> button.</Step>
        <Step n={5}><strong className="text-white">💬 Text system summary</strong> sends the customer a link to a clean, phone-friendly overview of their system. It shows only customer-appropriate details — <strong className="text-white">never</strong> the gate code, internal dollar figures, or private notes.</Step>
