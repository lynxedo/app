  ...
  return (
    <>
      ...
      <Section title="Reports vs Scoreboards">
        ...
        <p className="mt-2 text-gray-400"><strong className="text-white">People Performance is the other exception, and it works the opposite way.</strong> Everyone in the Hub can open it, because it is where you see <em>your own</em> numbers — what you sold, the work you produced, your revenue per clocked hour, and the calls and texts you handled. You do <em>not</em> need Reports access for that. What the <strong className="text-white">People Performance</strong> grant in Admin → Reports buys is the <strong className="text-white">team view</strong>: everyone else&apos;s rows alongside yours. Without it you see one row — your own.</p>

        <p className="mt-2 text-gray-400"><strong className="text-white">What it deliberately does not show.</strong> No pay, anywhere — hours, revenue and revenue-per-hour only, never a wage or a labour cost. No coaching grades: nobody sees their own grade, and Call Coaching stays its own report behind its own permission. And there is no personal &ldquo;answer rate&rdquo;, because a call is stamped to whoever the phone line points at before it is even offered — answered-versus-routed would say more about the routing than about the person. Calls answered and calls placed are shown as plain counts, and the office-wide answer rate sits in its own card where it belongs.</p>

        <p className="mt-2 text-gray-400"><strong className="text-white">Why your $/hour is compared to your department, not the company.</strong> Different service lines earn very different amounts per hour — pet waste and irrigation are not the same business. Ranking everyone together would say more about which line someone works than about how they are doing, so your figure is shown against your own department&apos;s average, and the department table carries the wider picture. Office roles have no hours in the field, so they get a sales-and-phone card with no $/hour at all — that is correct, not missing.</p>
