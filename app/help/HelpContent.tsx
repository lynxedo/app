  ...
  return (
    <>
      ...
      <Section title="Irrigation system">
        ...
        <Step n={4}><strong className="text-white">Add zones by voice.</strong> At the top of the <em>Zones</em> section, tap <strong className="text-white">🎙 Start talking</strong> and walk the yard describing what you see — say the zone number first, then the details: <em>&ldquo;Zone three, front lawn, turf, rotors, six heads, full sun — one broken head spraying the driveway.&rdquo;</em> Keep going for as many zones as you like, then tap <strong className="text-white">Stop &amp; fill zones</strong>. The zone blocks fill themselves in. No microphone, or too loud outside? Tap <strong className="text-white">Type instead</strong> and write the same notes — it works exactly the same way.</Step>
        <Step n={5}><strong className="text-white">Check the amber fields.</strong> Anything filled from your notes is highlighted amber and marked <em>• from notes</em>, and each zone gets a <strong className="text-white">Looks right ✓</strong> bar — so you only re-read what the microphone wrote, not the whole form. Tapping a field or the bar clears the highlight. Two things it will never do: it <strong className="text-white">never changes something you typed yourself</strong>, and if it didn&apos;t clearly hear a value it <strong className="text-white">leaves the field blank rather than guessing</strong>. A blank you can fill beats a confident wrong answer.</Step>
        <Step n={6}>Tap <strong className="text-white">Save inspection</strong> when you&apos;re done — that stamps a permanent dated record. Left as a draft, it shows a &ldquo;draft in progress&rdquo; note and a <strong className="text-white">Resume draft</strong> button.</Step>
        <Step n={7}><strong className="text-white">💬 Text system summary</strong> sends the customer a link to a clean, phone-friendly overview of their system. It shows only customer-appropriate details — <strong className="text-white">never</strong> the gate code, internal dollar figures, or private notes.</Step>
