  ...
  return (
    <>
      ...
      <Section title="Email Marketing (new — foundation)">
        ...
        <AdminOnly>Access is per-user via <strong className="text-white">Admin → People → Tools → Email Marketing</strong>; managing the sending identity is the separate <em>Email Marketing</em> admin grant.</AdminOnly>
      </Section>
    </>
  )
}
