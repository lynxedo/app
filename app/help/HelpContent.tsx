  ...
  return (
    <>
      ...
      <Section title="The conversation list">
        ...
        <p><strong className="text-white">Archive all mine</strong> — the <strong className="text-white">🗄 Archive all mine</strong> button near the top of the Txt sidebar (with <em>+ New conversation</em> / <em>+ Add contact</em>) archives every conversation you currently own in one tap. On mobile, open the conversation list first (the menu button on the left edge). It asks you to confirm with a count first, and it only touches threads you <em>own</em> — conversations you&apos;ve merely joined as a member are left alone.</p>
