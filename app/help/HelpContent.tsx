  ...
  return (
    <>
      ...
      <Section title="Reports vs Scoreboards">
        ...
        <p className="mt-2 text-gray-400">On <strong className="text-white">Crew &amp; Labor</strong>, the cards show the period they could actually measure, which may be shorter than the range you picked — the timeclock has a start date, and dividing a longer stretch of revenue by a shorter stretch of hours would overstate revenue per hour badly. The card tells you when that happens. People with clocked hours but no matching Jobber user still count toward hours and wages but carry no revenue-per-hour, and they&apos;re named so the gap is visible; salaried staff and anyone under an hour aren&apos;t ranked. Labor cost is <em>hourly field wages only</em>, not total payroll.</p>
...
<p className="mt-3"><strong className="text-white">If a line shows $0, its programs are missing a visits-per-year.</strong> A book&apos;s annual value is visits-per-year × price, so a program without that number adds nothing. The card tells you how many jobs it couldn&apos;t price and which lines they&apos;re on, rather than quietly reporting zero. Ask an admin to set it in <strong className="text-white">Admin &rarr; Reports &rarr; Recurring programs</strong>.</p>
      ...
      <Section title="Narrowing A Card To One Person">
        ...
        <p className="mt-3"><strong className="text-white">One person&apos;s labor cost.</strong> Same idea for wages: add <strong className="text-white">Labor Cost % — One Person</strong> and tick a name to see what share of the work <em>they</em> produced went to <em>their</em> wages. Both halves are theirs, which is what makes it a real number — the company&apos;s <strong className="text-white">Labor Cost % of Revenue</strong> divides wages by <em>all</em> company revenue, so filtering only the wage half of it would report about 2% and mean nothing. Tick several names for the crew&apos;s combined figure, weighted rather than averaged.</p>
