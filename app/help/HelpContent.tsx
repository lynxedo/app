  ...
  return (
    <>
      ...
      <Section title="Pop out a conversation">
        ...
        <Note>🔒 <strong className="text-white">Locking the app (Android app).</strong> <em className="text-amber-300">Arriving with the next app update.</em> In <strong className="text-white">Settings → My Hub</strong> there&apos;s <strong className="text-white">Lock this app</strong> — turn it on and Lynxedo asks for your fingerprint before it opens. You stay signed in; this is about someone else picking the phone up, not about signing in again. It only asks after the app has been away for about five minutes, so sending an OMW or following Navigate into Maps and coming back won&apos;t challenge you mid-stop. ⚠ Your phone&apos;s own PIN always works as a way in, so a wet or cut finger can never lock you out of your route. The setting lives on that one phone — it doesn&apos;t lock Lynxedo on anyone else&apos;s device or on a computer.</Note>
