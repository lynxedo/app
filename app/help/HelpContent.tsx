  ...
  return (
    <>
      ...
      <Section title="Unified inbox (calls + voicemails)">
        <p>When <strong className="text-white">Unified Inbox</strong> is turned on for you (Admin → People), each customer thread becomes one chronological story of <em>every</em> way you&apos;ve talked: texts as bubbles, plus inline markers for <strong className="text-white">📞 calls</strong> and <strong className="text-white">🎙 voicemails</strong>. Tap a call or voicemail marker to expand it — play the recording right in the app, read the AI summary and sentiment, and open the full transcript. A missed call that left a voicemail shows as <em>one</em> combined marker, not two.</p>
      ...
      <AdminOnly>
        ...
        <p><strong className="text-white">Unified Inbox</strong> is a separate per-person toggle in <strong className="text-white">Admin → People</strong> (&quot;Unified Inbox&quot;, off by default; admins always have it). It layers calls, voicemails, and the AI features below onto a person&apos;s Txt2 — see the <strong className="text-white">Unified inbox (calls + voicemails)</strong> section above.</p>
