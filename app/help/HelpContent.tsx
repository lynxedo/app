  ...
  return (
    <>
      ...
      <Section title="Email Marketing (new)">
        ...
        <p className="mt-2"><strong className="text-white">Images &amp; logos</strong> are uploaded right in the composer (JPEG/PNG/GIF/WebP, up to 5 MB) and hosted for you, so they load reliably in inboxes. Text and button blocks support <strong className="text-white">merge fields</strong> — <code className="text-gray-300">{'{{first_name}}'}</code>, <code className="text-gray-300">{'{{last_name}}'}</code>, <code className="text-gray-300">{'{{email}}'}</code> — that fill in per-recipient at send time. Switch to the <em>Preview</em> tab to see the finished email with sample values, or <em>Send test to myself</em> to get it in your own inbox (subject prefixed <em>[TEST]</em>, merge fields filled with your name).</p>
