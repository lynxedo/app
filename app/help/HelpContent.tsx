  ...
  return (
    <>
      ...
      <Section title="Narrowing A Card To One Person">
        ...
        <p className="mt-3"><strong className="text-white">Cards that have it:</strong> Visit Revenue by Technician · Hours Clocked · Revenue per Hour by Technician · Hours by Person · Crew Detail · Sales by Person · Quotes By Salesperson · Quotes Waiting For An Answer · both Tracked Items cards.</p>
