  ...
  return (
    <>
      ...
      <Section title="Assigning &amp; collaborating">
        ...
        <p className="mt-3"><strong className="text-white">Archiving</strong> a thread is owner-level — only the conversation&apos;s owner or a Texting Manager can archive it, from the header&apos;s <strong className="text-white">⋯</strong> menu. <strong className="text-white">Reopening</strong> an archived thread, though, is open to anyone with Txt: tap <strong className="text-white">Reopen to reply</strong> (or <strong className="text-white">↺ Reopen conversation</strong> in the ⋯ menu) and the conversation comes back to your inbox and becomes yours, so you can text the customer right away.</p>
