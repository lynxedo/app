...
<p className="mt-3"><strong className="text-white">If a line shows $0, its programs are missing a visits-per-year.</strong> A book&apos;s annual value is visits-per-year × price, so a program without that number adds nothing. The card tells you how many jobs it couldn&apos;t price and which lines they&apos;re on, rather than quietly reporting zero. Ask an admin to set it in <strong className="text-white">Admin &rarr; Reports &rarr; Recurring programs</strong>.</p>
      ...
      <Section title="Commission">
        ...
        <p className="mt-3"><strong className="text-white">Seeing the deals behind a figure.</strong> The Commission Detail card carries a <strong className="text-white">See the deals behind these figures</strong> link: a full page listing every Lead Tracker deal the sales-based rules were paid on, each marked <em>New business</em> or <em>Upsell</em>, with a Download for Excel button. It carries the card&apos;s person filter through, so the list matches the number you clicked. Rules paid on <em>revenue produced</em>, on a <em>whole service line</em>, or on <em>particular things sold</em> aren&apos;t in that list — those figures have no deal list behind them, and the page says so rather than showing a total that doesn&apos;t add up.</p>
