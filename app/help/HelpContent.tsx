    ...
    <>
      ...
      <Section title="Navigation — rail + sidebars">
        ...
        <ul className="list-disc list-inside text-gray-400 space-y-1 ml-2">
          <li><strong className="text-white">🔍 Search</strong> (top) — opens the search palette (same as <kbd className="px-1 py-0.5 rounded bg-white/10 text-xs">⌘K</kbd> / <kbd className="px-1 py-0.5 rounded bg-white/10 text-xs">Ctrl+K</kbd>). Jump to a room or person by name, or <strong className="text-white">type any keyword to search messages</strong> across every room and DM you&apos;re in — results show who said it, where, and when, with your keyword highlighted. Tap a result to open that conversation.</li>
          ...
          <li><strong className="text-white">▦ Apps</strong> (always present) — the full menu / app drawer (a <strong className="text-white">+N</strong> shows how many more are tucked in there), and where you re-add anything you&apos;ve hidden. A <strong className="text-white">search bar at the top</strong> filters the icons as you type — the fastest way to find an app in a long menu (on the phone&apos;s Apps sheet too).</li>
        ...
        <p>The bottom bar shows the <strong className="text-white">first 5 items of your one menu</strong> (the same list as the desktop rail), then a fixed <strong className="text-white">Apps</strong> button. New accounts start with <strong className="text-white">Hub · Txt · Phone · Clock</strong>. Want a different icon on the bar? Drag it into the top 5 in the customizer. Tap <strong className="text-white">Apps</strong> for the full menu (everything past the first 5) and to open <strong className="text-white">Customize</strong>. A floating <strong className="text-white">+</strong> button in the bottom-right opens the quick compose / search palette.</p>
