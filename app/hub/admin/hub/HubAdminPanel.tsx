    ...
    <div>
      ...
      <div className="flex gap-1 mb-8 border-b border-gray-800">
        {([
          ...
          <button
            key={key}
            onClick={() => { setTab(key); if (key === 'automation') loadAutomationRules(); if (key === 'chat-synx') { if (!chatSynxLinksLoaded) loadChatSynxLinks(); if (!chatSynxBridgesLoaded) loadChatSynxBridges(); } }}
