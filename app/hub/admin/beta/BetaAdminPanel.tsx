    ...
    <div className="space-y-8">
      ...
      <div className="rounded-xl border border-white/10 bg-white/[0.03] p-4">
        ...
        <button
          ...
          disabled={creating}
          className="mt-3 rounded-lg bg-sky-500 px-4 py-2 text-sm font-semibold text-[#fff] hover:bg-sky-400 disabled:opacity-50"
        >
    ...
    <div className="rounded-xl border border-white/10 bg-white/[0.03] p-4">
      ...
      <div className="mt-4 flex items-center justify-between">
        <button
          ...
          className="rounded-lg bg-sky-500 px-3 py-1.5 text-sm font-semibold text-[#fff] hover:bg-sky-400 disabled:opacity-40"
        >
