...
export default async function SettingsPage() {
  ...
  const [hubUserResult, profileResult, notifPrefResult] = await Promise.all([
    ...
    supabase
      .from('user_profiles')
      .select('role, phone, full_name, landing_page, rail_config, txt_signature, dialer_global_ring, hub_theme, can_access_tracker, can_access_routing, can_access_fleet, can_access_books, can_access_lawn, can_access_zone_sizer, can_access_call_log, can_access_call_log2, can_access_timesheet, can_access_dialer, can_access_txt, can_access_marketing, can_access_forms, can_access_daily_log_v2, can_access_scoreboards, can_access_files, can_access_pesticide_records, can_access_pricer, can_access_hub, master_dnd_enabled, master_dnd_schedule, hub_dnd_enabled, hub_dnd_schedule, dialer_dnd_enabled, dialer_dnd_schedule')
      .eq('id', user.id)
      .maybeSingle(),
    supabase
