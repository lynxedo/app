...
const DEPT_COLORS: Record<string, { bg: string; border: string; label: string }> = {
  ...
  PW: { bg: 'rgba(245,158,11,0.75)', border: '#f59e0b', label: 'Pest Control (PW)' },
...
export default function Scoreboard2View({ meta }: { meta: ScoreboardMeta }) {
  ...
  return (
    <div className="flex-1 min-h-0 overflow-y-auto bg-[#0b1929] text-slate-200">
      <header className="flex items-center gap-3.5 border-b border-emerald-400/15 bg-gradient-to-br from-[#0f2e47] to-[#1a3d5c] px-5 py-4 max-md:pl-14">
