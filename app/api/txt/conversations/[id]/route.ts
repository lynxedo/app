...
export async function GET(
  ...
  let msgQuery = supabase
    .from('txt_messages')
    .select(
      'id, direction, body, media_urls, status, error_message, twilio_sid, created_at, sent_by, phone_number_id, rerouted, sender:hub_users!sent_by ( id, display_name ), number:txt_phone_numbers!txt_messages_phone_number_id_fkey ( label, twilio_number )'
    )
