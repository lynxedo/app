...
const SYSTEM_PROMPT = [
  `You are summarizing a customer's full communication history for Heroes Lawn Care staff who are about to text or call them and need to get up to speed fast.`,
  ``,
