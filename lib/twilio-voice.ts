...
import type { IvrPrompt, IvrAction, IvrNode, IvrTree, IvrConfig, IvrTreeName, BusinessHoursSchedule, HolidayEntry } from './ivr-routing'
...
// IVR types and routing helpers live in lib/ivr-routing.ts (client-safe).
// Re-exported here so existing server-side callers are unaffected.
export type { IvrPrompt, IvrAction, IvrNode, IvrTree, IvrConfig, IvrTreeName, BusinessHoursSchedule, HolidayEntry } from './ivr-routing'
export { isWithinBusinessHours, isHolidayToday, pickIvrTree } from './ivr-routing'
...
// NT7: isInDndSchedule + userIsDndNow live in the client-safe lib/dnd-schedule.ts.
// Re-exported here so existing '@/lib/twilio-voice' callers keep working.
