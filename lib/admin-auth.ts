...
export type AdminArea = 'people' | 'hub' | 'routing' | 'timesheet' | 'fleet' | 'daily_log' | 'dialer' | 'contacts' | 'guardian' | 'ai' | 'marketing' | 'email' | 'forms' | 'products' | 'txt' | 'announcements' | 'file_tags' | 'integrations'
